...
export const env = {
  ...
  DOCUSEAL_SUBMITTER_ROLE: getEnv('DOCUSEAL_SUBMITTER_ROLE', 'First Party'),
  ...
  PYTHON_SERVICE_URL: getEnv('PYTHON_SERVICE_URL', 'http://localhost:8000'),
  PYTHON_SERVICE_TOKEN: getEnv('PYTHON_SERVICE_TOKEN', 'dev'),
  RATECON_WEBHOOK_SECRET: getEnv('RATECON_WEBHOOK_SECRET', 'dev'),
  RATECON_INBOUND_DOMAIN: getEnv('RATECON_INBOUND_DOMAIN', 'notify.localhost'),
  RATECON_DEV_MAILPIT_INBOUND: getEnv('RATECON_DEV_MAILPIT_INBOUND', 'false') === 'true',
  MAILPIT_API_URL: getEnv('MAILPIT_API_URL', 'http://localhost:8025'),
} as const;
