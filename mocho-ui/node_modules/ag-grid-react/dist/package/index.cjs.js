...
var AgGridReactUi = (props) => {
  ...
  const appliedClassName = (0, import_react25.useRef)();
  ...
  return (
    ...
    /* @__PURE__ */ import_react25.default.createElement("div", { style, ref: setRef2 }, /* @__PURE__ */ import_react25.default.createElement(RenderModeContext.Provider, { value: renderMode }, context && !context.isDestroyed() ? /* @__PURE__ */ import_react25.default.createElement(gridComp_default, { key: context.instanceId, context }) : null, portalManager.current?.getPortals() ?? null))
  );
};
