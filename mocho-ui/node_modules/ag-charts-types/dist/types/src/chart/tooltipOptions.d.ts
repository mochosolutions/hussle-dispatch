...
import type { AgMarkerShape, ContextDefault, DatumDefault, DurationMs, InteractionRange, PixelSize, TextWrap } from './types';
...
export interface AgSeriesTooltipRendererParams<TDatum, TContext = ContextDefault> extends Omit<AgChartCallbackParams<TDatum, TContext>, 'itemId' | 'itemType'> {
