...
}, "variant" | "children" | "style" | "className" | "classes" | "sx" | "color" | "position" | "elevation" | "square" | "enableColorOnDark"> & import('@mui/system').MUIStyledCommonProps<import('@mui/material').Theme> & Props, {}, {}>;
