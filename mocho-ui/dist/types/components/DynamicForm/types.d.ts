 ...
 */
export type FieldConfig = InputFieldConfig | TextareaFieldConfig | SelectFieldConfig | SlugFieldConfig | CharCounterFieldConfig | AutocompleteFieldConfig | FileUploadFieldConfig | CustomFieldConfig;
/**
 * Type guard to check if a field is an input field
 */
export declare function isInputField(field: FieldConfig): field is InputFieldConfig;
/**
 * Type guard to check if a field is a textarea field
 */
export declare function isTextareaField(field: FieldConfig): field is TextareaFieldConfig;
/**
 * Type guard to check if a field is a select field
 */
export declare function isSelectField(field: FieldConfig): field is SelectFieldConfig;
/**
