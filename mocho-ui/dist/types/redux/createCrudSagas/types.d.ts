...
export type CrudOperation = 'fetchAll' | 'fetchById' | 'create' | 'update' | 'delete' | 'updateMany' | 'deleteMany';
 ...
 */
export interface LifecycleHooks<TEntity, TCreateInput = Partial<TEntity>, TUpdateInput = Partial<TEntity>> {
    ...
    beforeUpdateMany?: (ids: string[], data: TUpdateInput) => Generator<Effect, boolean, unknown>;
     ...
     */
    onError?: (operation: CrudOperation, error: Error, context?: {
        id?: string;
        ids?: string[];
 ...
 */
export interface CrudApiClient<TEntity, TCreateInput = any, TUpdateInput = any> {
...
export interface CrudActions<TEntity> {
    ...
    fetchFailure?: ActionCreatorWithPayload<{
        error: string;
    }>;
    fetchByIdRequest?: ActionCreatorWithPayload<{
        id: string;
    }>;
    ...
    createFailure?: ActionCreatorWithPayload<{
        error: string;
    }>;
    ...
    deleteRequest?: ActionCreatorWithPayload<{
        id: string;
    }>;
    deleteSuccess?: ActionCreatorWithPayload<{
        id: string;
    }>;
...
export interface BulkActions<TUpdateInput = unknown> {
    deleteManyRequest?: ActionCreatorWithPayload<{
        ids: string[];
    }>;
    deleteManySuccess?: ActionCreatorWithPayload<BulkDeleteResult>;
    deleteManyFailure?: ActionCreatorWithPayload<{
        error: string;
    }>;
    updateManyRequest?: ActionCreatorWithPayload<{
        ids: string[];
        data: TUpdateInput;
    }>;
    updateManySuccess?: ActionCreatorWithPayload<BulkUpdateResult>;
    updateManyFailure?: ActionCreatorWithPayload<{
        error: string;
    }>;
}
/**
...
export interface NormalizationConfig {
    ...
    handleRelatedEntities?: (normalizedData: Record<string, Record<string, unknown>>) => Generator<PutEffect, void, unknown>;
}
 ...
 * @template TUpdateInput - Input type for update operation
 */
export interface CrudSagaConfig<TEntity extends {
    id: string;
}, TCreateInput = Partial<TEntity>, TUpdateInput = Partial<TEntity>> {
    ...
    confirmation?: {
        delete?: ConfirmationConfig<string>;
        update?: ConfirmationConfig<{
            id: string;
            data: TUpdateInput;
        }>;
        deleteMany?: ConfirmationConfig<string[]>;
        updateMany?: ConfirmationConfig<{
            ids: string[];
            data: TUpdateInput;
        }>;
    };
...
export interface CrudSagas<TCreateInput = unknown, TUpdateInput = unknown> {
    ...
    fetchById: (action: PayloadAction<{
        id: string;
    }>) => Generator<Effect, void, unknown>;
    create: (action: PayloadAction<{
        data: TCreateInput;
    }>) => Generator<Effect, void, unknown>;
    update: (action: PayloadAction<{
        id: string;
        data: TUpdateInput;
    }>) => Generator<Effect, void, unknown>;
    delete: (action: PayloadAction<{
        id: string;
    }>) => Generator<Effect, void, unknown>;
    updateMany?: (action: PayloadAction<{
        ids: string[];
        data: TUpdateInput;
    }>) => Generator<Effect, void, unknown>;
    deleteMany?: (action: PayloadAction<{
        ids: string[];
    }>) => Generator<Effect, void, unknown>;
}
