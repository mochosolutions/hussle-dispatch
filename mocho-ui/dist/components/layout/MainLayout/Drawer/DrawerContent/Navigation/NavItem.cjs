...
const NavItem = ({
  ...
  let listItemProps = {
    component: React.forwardRef((props, ref) => /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Link, { ...props, to: item.url ?? "", target: itemTarget, ref }))
  };
  if (item?.external) {
    listItemProps = {
      component: "a",
  ...
  const itemIcon = Icon ? /* @__PURE__ */ jsxRuntime.jsx(Icon, { style: {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: menuOrientation === config.MenuOrientation.VERTICAL || downLG ? /* @__PURE__ */ jsxRuntime.jsxs(material.ListItemButton, { ...listItemProps, disabled: item.disabled, selected: isSelected, sx: {
    zIndex: 1201,
    ...
    (drawerOpen || !drawerOpen && level !== 1) && /* @__PURE__ */ jsxRuntime.jsx(material.ListItemText, { primary: /* @__PURE__ */ jsxRuntime.jsx(material.Typography, { variant: "h6", sx: {
      color: isSelected ? iconSelectedColor : textColor
    }, children: item.title }) }),
    (drawerOpen || !drawerOpen && level !== 1) && item.chip && /* @__PURE__ */ jsxRuntime.jsx(material.Chip, { color: item.chip.color, variant: item.chip.variant, size: item.chip.size, label: item.chip.label, avatar: item.chip.avatar && /* @__PURE__ */ jsxRuntime.jsx(material.Avatar, { children: item.chip.avatar }) })
  ] }) : /* @__PURE__ */ jsxRuntime.jsxs(material.ListItemButton, { ...listItemProps, disabled: item.disabled, selected: isSelected, sx: {
    zIndex: 1201,
    ...drawerOpen && {
      "&:hover": {
        bgcolor: "transparent"
    ...
    /* @__PURE__ */ jsxRuntime.jsx(material.ListItemText, { primary: /* @__PURE__ */ jsxRuntime.jsx(material.Typography, { variant: "h6", color: "inherit", children: item.title }) }),
    (drawerOpen || !drawerOpen && level !== 1) && item.chip && /* @__PURE__ */ jsxRuntime.jsx(material.Chip, { color: item.chip.color, variant: item.chip.variant, size: item.chip.size, label: item.chip.label, avatar: item.chip.avatar && /* @__PURE__ */ jsxRuntime.jsx(material.Avatar, { children: item.chip.avatar }) })
  ] }) });
};
