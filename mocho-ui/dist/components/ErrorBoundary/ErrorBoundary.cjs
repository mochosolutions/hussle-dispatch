...
class ErrorBoundary extends React.Component {
  ...
  render() {
    ...
    if (hasError && error) {
      ...
      return /* @__PURE__ */ jsxRuntime.jsx(DefaultErrorFallback, { error, context, onReset: this.resetErrorBoundary });
    }
    return children;
  }
}
function DefaultErrorFallback({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: {
    ...
    process.env.NODE_ENV === "development" && /* @__PURE__ */ jsxRuntime.jsxs("details", { style: {
      marginBottom: "1.5rem",
      textAlign: "left",
      maxWidth: "600px"
    }, children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsxs("pre", { style: {
        padding: "1rem",
    ...
    /* @__PURE__ */ jsxRuntime.jsx("button", { onClick: onReset, style: {
