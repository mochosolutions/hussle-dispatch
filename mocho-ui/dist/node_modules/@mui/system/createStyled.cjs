...
const createStyled = require("../../../_virtual/createStyled2.cjs");
const interopRequireDefault = require("../../@babel/runtime/helpers/interopRequireDefault.cjs");
const _extends = require("../../@babel/runtime/helpers/extends.cjs");
const objectWithoutPropertiesLoose = require("../../@babel/runtime/helpers/objectWithoutPropertiesLoose.cjs");
...
function requireCreateStyled() {
  ...
  createStyled.__exports.systemDefaultTheme = void 0;
...
//# sourceMappingURL=createStyled.cjs.map
