...
const useForkRef = require("../node_modules/@mui/utils/esm/useForkRef/useForkRef.cjs");
const getReactElementRef = require("../node_modules/@mui/utils/esm/getReactElementRef/getReactElementRef.cjs");
const ownerDocument = require("../node_modules/@mui/utils/esm/ownerDocument/ownerDocument.cjs");
const elementAcceptingRef = require("../node_modules/@mui/utils/esm/elementAcceptingRef/elementAcceptingRef.cjs");
const exactProp = require("../node_modules/@mui/utils/esm/exactProp/exactProp.cjs");
...
process.env.NODE_ENV !== "production" ? FocusTrap.propTypes = {
   ...
   * @default false
   */
  disableEnforceFocus: index.bool,
  /**
   * If `true`, the focus trap will not restore focus to previously focused element once
   * focus trap is hidden or unmounted.
   * @default false
   */
  disableRestoreFocus: index.bool,
  /**
   * Returns an array of ordered tabbable nodes (i.e. in tab order) within the root.
   * For instance, you can provide the "tabbable" npm dependency.
   * @param {HTMLElement} root
   */
  getTabbable: index.func,
  /**
   ...
   * }
   */
  isEnabled: index.func,
  /**
   * If `true`, focus is locked.
   */
  open: index.bool.isRequired
} : void 0;
if (process.env.NODE_ENV !== "production") {
