...
const sliceHelpers = require("./sliceHelpers.cjs");
...
function createCrudSelectors(sliceSelector) {
  return {
     ...
     */
    selectIsLoading: (operation) => (state) => sliceSelector(state).loading[operation] === loadingState.LoadingState.Pending,
    /**
     * Select loading state for entity-specific operation
     * Uses composite key format: 'operation:entityId'
     */
    selectIsEntityLoading: (operation, entityId) => (state) => sliceSelector(state).loading[`${operation}:${entityId}`] === loadingState.LoadingState.Pending,
    /**
...
exports.createCrudSelectors = createCrudSelectors;
exports.createCrudSlice = createCrudSlice;
exports.getCrudActionNames = getCrudActionNames;
