...
export function createCrudSlice(config: CrudSliceConfig) {
  ...
  if (operations.includes('getAll')) {
    ...
    reducers[`fetch${capitalizedPlural}Request`] = (
      state,
    ...
    reducers[`fetch${capitalizedPlural}Success`] = (state, _action: PayloadAction<unknown>) => {
      setFulfilled(state, { loadingKey: 'getAll', errorKey: 'getAll' });
    };

    reducers[`fetch${capitalizedPlural}Failure`] = (state, action: PayloadAction<FailurePayload>) => {
      setRejected(state, {
        loadingKey: 'getAll',
        errorKey: 'getAll',
  ...
  if (operations.includes('getById')) {
    ...
    reducers[`fetch${capitalizedSingular}DetailsRequest`] = (
      state,
    ...
    reducers[`fetch${capitalizedSingular}DetailsSuccess`] = (
      state,
    ...
    reducers[`fetch${capitalizedSingular}DetailsFailure`] = (
      state,
  ...
  if (operations.includes('create')) {
    ...
    reducers[`create${capitalizedSingular}Request`] = (
      state,
    ...
    reducers[`create${capitalizedSingular}Success`] = (state, _action: PayloadAction<unknown>) => {
      setFulfilled(state, { loadingKey: 'create', errorKey: 'create' });
    };

    reducers[`create${capitalizedSingular}Failure`] = (
      state,
      action: PayloadAction<FailurePayload>
    ) => {
      setRejected(state, {
  ...
  if (operations.includes('update')) {
    ...
    reducers[`update${capitalizedSingular}Request`] = (
      state,
    ...
    reducers[`update${capitalizedSingular}Success`] = (
      state,
    ...
    reducers[`update${capitalizedSingular}Failure`] = (
      state,
      action: PayloadAction<FailurePayload>
    ) => {
  ...
  if (operations.includes('delete')) {
    ...
    reducers[`delete${capitalizedSingular}Request`] = (
      state,
    ...
    reducers[`delete${capitalizedSingular}Success`] = (
      state,
    ...
    reducers[`delete${capitalizedSingular}Failure`] = (
      state,
      action: PayloadAction<FailurePayload>
    ) => {
