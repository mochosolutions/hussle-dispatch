 ...
 */
export interface PasswordFieldProps<T = Record<string, unknown>>
  extends Omit<BaseInputFieldProps<T>, 'disabled'> {
 ...
 */
export interface PasswordFieldWithStrengthProps<T = Record<string, unknown>>
 ...
 */
export interface PasswordFieldWithChecklistProps<T = Record<string, unknown>>
  extends PasswordFieldProps<T> {
 ...
 */
export interface ConfirmPasswordFieldProps<T = Record<string, unknown>>
  extends PasswordFieldProps<T> {}
