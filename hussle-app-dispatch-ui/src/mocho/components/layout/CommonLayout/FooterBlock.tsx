...
const FooterBlock = ({isFull}: showProps) => {
  ...
  return (
    <>
            ...
            '&:after': {
              ...
              background:
                theme.direction === ThemeDirection.RTL
                  ...
                  : `linear-gradient(180deg, transparent 0%, ${theme.palette.grey[800]} 70%)`,
            },
          }}
        >
          <CardMedia
      ...
      <Box sx={{pt: isFull ? 0 : 10, pb: 10, bgcolor: theme.palette.grey[800]}}>
        <Container>
        ...
        <Container>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={4}>
              {/* TODO: Add social media icons when available */}
              {/* <Grid
                container
                spacing={2}
                alignItems="center"
