 ...
 * Stores calculatedTotalMiles and isEstimated in formik for RateSidebar consumption.
 */
export const useRouteDistance = (
  ...
  const resetState = useCallback(() => {
    ...
    void setFieldValueRef.current('calculatedTotalMiles', null);
    ...
    (waypoints: Waypoint[], fp: string) => {
      ...
      void calculateRouteDistance(waypoints)
        .then((result) => {
          ...
          void setFieldValueRef.current('calculatedTotalMiles', Math.round(result.totalMiles));
