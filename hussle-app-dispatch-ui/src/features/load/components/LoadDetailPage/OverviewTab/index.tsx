    ...
    <Stack spacing={2}>
      <Grid container spacing={2}>
        <Grid item xs={12} md={8}>
          ...
          {(load.dispatcherNotes ?? load.driverInstructions) && (
            <SectionCard
        ...
        <Grid item xs={12} md={4}>
          <Stack spacing={2}>
            ...
            />
            {load.customer && (
              <SectionCard title="Customer" contentSX={{ p: 0 }}>
                <DetailRow label="Company" value={load.customer.companyName} noBorder />
              </SectionCard>
            )}
            <BrokerCard
