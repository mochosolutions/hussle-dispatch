...
jest.mock('features/carrier-portal-v2/components/LaneStateMap', () => ({
  __esModule: true,
  default: () => <div data-testid="LaneStateMap" />,
}));

jest.mock('features/carrier-portal-v2/components/ScheduleGrid', () => ({
  __esModule: true,
  default: () => <div data-testid="ScheduleGrid" />,
}));

jest.mock('features/carrier-portal-v2/components/SchedulePresetGroup', () => ({
  __esModule: true,
  default: () => <div data-testid="SchedulePresetGroup" />,
}));

jest.mock('features/carrier-portal-v2/components/OptCard', () => ({
  __esModule: true,
  default: ({ label }: { label: string }) => <div data-testid={`OptCard-${label}`} />,
}));

jest.mock('features/carrier-portal-v2/components/FreightChip', () => ({
  __esModule: true,
  default: ({ label }: { label: string }) => <div data-testid={`FreightChip-${label}`} />,
}));

jest.mock('features/carrier-portal-v2/components/ScopeBar', () => ({
  __esModule: true,
  default: ({
    options,
    value,
...
jest.mock('features/carrier-portal-v2/components/DriverChip', () => ({
  __esModule: true,
...
jest.mock('features/carrier-portal-v2/components/SectionHead', () => ({
  __esModule: true,
...
jest.mock('features/carrier-portal-v2/components/OverrideBadge', () => ({
  __esModule: true,
  default: () => <span data-testid="OverrideBadge">Override</span>,
}));

jest.mock('features/carrier-portal-v2/components/EditingCallout', () => ({
  __esModule: true,
