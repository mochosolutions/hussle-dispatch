...
module.exports = {
  forbidden: [
    ...
    },
    {
      ...
      severity: 'error',
      comment:
        'carrier-portal engine module must remain pure: files under engine/ may only ' +
      ...
      from: {
        path: '^src/features/carrier-portal/engine/',
        pathNot: [
          '^src/features/carrier-portal/engine/__tests__/',
        ],
      },
      to: {
        pathNot: [
          '^src/features/carrier-portal/engine/',
